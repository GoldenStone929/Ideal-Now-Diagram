...
<body>
  ...
  <script>
    (function () {
      ...
      let nodes = [
        {
          id: "UserRequest", label: "UserRequest", x: 560, y: 80, kind: "main",
          role: "Task entry", detail: "Receives user request and starts a run context.",
          inside: ["Raw user goal", "Task text", "Requester metadata"],
        },
        {
          id: "TaskIntake", label: "TaskIntake", x: 560, y: 160, kind: "main",
          role: "Normalize request", detail: "Builds task_card and checks required fields.",
          inside: ["task_id / run_id", "task_type detection", "initial status and tracking"],
        },
        {
          id: "Clarification", label: "Clarification", x: 560, y: 240, kind: "main",
          role: "Resolve ambiguity", detail: "Asks missing questions (Big N, TEAE, groups, windows).",
          inside: ["Mandatory questions", "Default assumptions", "Clarification history log"],
        },
        {
          id: "Retrieval", label: "Retrieval", x: 560, y: 320, kind: "main",
          role: "Find references", detail: "Fetches relevant code/logic/templates with status priority.",
          inside: ["Hybrid search", "Status-aware ranking", "Top-k evidence bundle"],
        },
        {
          id: "Generation", label: "Generation", x: 560, y: 400, kind: "main",
          role: "Create draft", detail: "Generates draft code from task + retrieval context.",
          inside: ["Prompt assembly", "Draft code artifact", "Draft asset_card metadata"],
        },
        {
          id: "Comparison", label: "Comparison", x: 560, y: 480, kind: "main",
          role: "Compare output", detail: "Compares generated artifact vs references and reports diffs.",
          inside: ["Logic diff", "Output diff", "Similarity score and issues"],
        },
        {
          id: "Validation", label: "Validation", x: 560, y: 560, kind: "main",
          role: "Automated checks", detail: "Runs metadata/dependency/syntax/promotion checks.",
          inside: ["Schema validation", "Dependency checks", "Promotion eligibility checks"],
        },
        {
          id: "HumanReview", label: "HumanReview", x: 560, y: 640, kind: "main",
          role: "Final gate", detail: "Human reviewer decides approve/revise/reject.",
          inside: ["Review note", "Decision outcome", "Writeback trigger"],
        },
        {
        ...
        },
        {
          ...
          role: "Runtime config", detail: "Provides model/retrieval/governance/path config.",
          inside: ["model config", "retrieval config", "governance config", "storage paths"],
        },
        {
          id: "AssetStore", label: "AssetStore", x: 860, y: 280, kind: "input",
          role: "Asset source", detail: "Holds draft/validated assets and indexes.",
          inside: ["asset libraries", "registry indexes", "linked references"],
        },
        {
          id: "ValidatedLibrary", label: "ValidatedLibrary", x: 330, y: 740, kind: "output",
          role: "Approved assets", detail: "Stores reviewer/prod approved reusable assets.",
          inside: ["reviewer_approved assets", "production_approved assets", "deprecation records"],
        },
        {
          id: "FailedCases", label: "FailedCases", x: 560, y: 740, kind: "fail",
          role: "Negative memory", detail: "Stores structured failures and root causes.",
          inside: ["failure_type", "root cause", "corrective actions", "pattern tags"],
        },
        {
          id: "RunsTrace", label: "RunsTrace", x: 790, y: 740, kind: "output",
          role: "Traceability", detail: "Stores per-run records for audit and replay.",
          inside: ["input snapshot", "decision logs", "retrieval evidence", "final outcome"],
        },
        {
          id: "MemoryCenter", label: "MemoryCenter", x: 560, y: 820, kind: "output",
          role: "Reusable memory", detail: "Stores solved patterns, reviewer decisions, common failures.",
          inside: ["solved patterns", "reviewer decisions", "common failures", "reusable notes"],
        },
      ];

      let edges = [
        {
          id: "e1", from: "UserRequest", to: "TaskIntake", kind: "main",
          why: "User intent must be normalized first.",
          does: "Creates structured task_card, run_id, and initial status.",
        },
        {
        ...
        {
          id: "e3", from: "Clarification", to: "Retrieval", kind: "main",
          why: "Retrieval quality depends on clarified constraints.",
          does: "Builds a precise query for assets and logic fragments.",
        },
        {
          id: "e4", from: "Retrieval", to: "Generation", kind: "main",
          why: "Generation should use validated prior knowledge.",
          does: "Supplies top assets and logic context to code generation.",
        },
        {
          id: "e5", from: "Generation", to: "Comparison", kind: "main",
          why: "New draft must be measured against baseline logic/output.",
          does: "Produces compare_result with differences and similarity.",
        },
        {
          id: "e6", from: "Comparison", to: "Validation", kind: "main",
          why: "Comparison findings guide strict automated validation.",
          does: "Runs metadata/dependency/syntax/promotion checks.",
        },
        {
        ...
        {
          id: "e8", from: "HumanReview", to: "ValidatedLibrary", kind: "output",
          via: [[476, 700], [476, 740], [414, 740]],
          why: "Approved outputs become reusable trusted assets.",
          does: "Writes asset into reviewer/prod approved library.",
        },
        {
          id: "e9", from: "HumanReview", to: "FailedCases", kind: "fail",
          why: "Rejected outputs should be captured as learning signals.",
          does: "Creates failed_case record with root cause and action.",
        },
        {
          id: "e10", from: "HumanReview", to: "RunsTrace", kind: "output",
          via: [[644, 700], [644, 740], [706, 740]],
          why: "Review decisions must be traceable.",
          does: "Writes review and promotion traces into run logs.",
        },
        {
          id: "e11", from: "FailedCases", to: "MemoryCenter", kind: "output",
          why: "Failure knowledge should prevent repetition.",
          does: "Extracts reusable failure patterns into memory.",
        },
        {
          id: "e12", from: "KnowledgeCenter", to: "Clarification", kind: "input",
          via: [[380, 120], [380, 240], [476, 240]],
          why: "Clarification needs explicit rule constraints, but the question generation itself is model-driven.",
          does: "Supplies rule templates and missing-info checklist that the clarification model turns into concrete questions.",
          executor: "Clarification model (LLM workflow).",
          source: "knowledge/task_clarification/* and policy docs.",
          note: "This edge is knowledge constraints, not embedding inference execution.",
        },
        {
          id: "e13", from: "KnowledgeCenter", to: "Retrieval", kind: "input",
          via: [[360, 120], [360, 320], [476, 320]],
          why: "Retrieval must follow policy and terminology.",
          does: "Contributes retrieval policy and domain vocabulary.",
          executor: "Hybrid retrieval engine.",
          source: "knowledge/policies/retrieval_policy.md and references/*.md",
        },
        {
          id: "e14", from: "KnowledgeCenter", to: "Validation", kind: "input",
          via: [[320, 120], [320, 560], [476, 560]],
          why: "Validation criteria are defined by standards/schemas.",
          does: "Feeds schema and policy checks for gatekeeping.",
          executor: "Validation workflow + validators.",
          source: "knowledge/standards/* and knowledge/schemas/*",
        },
        {
          id: "e15", from: "ConfigCenter", to: "TaskIntake", kind: "input",
          via: [[760, 80], [760, 140], [644, 140]],
          why: "Intake behavior should be configuration-driven.",
          does: "Provides model selection and path settings.",
          executor: "Task intake flow.",
          source: "config/models/* and config/storage/paths.yaml",
        },
        {
          id: "e16", from: "ConfigCenter", to: "Retrieval", kind: "input",
          via: [[920, 80], [980, 80], [980, 300], [644, 300]],
          why: "Retrieval settings change without code edits.",
          does: "Provides chunking/ranking/index policy values.",
          executor: "Hybrid retrieval + reranker pipeline.",
          source: "config/retrieval/chunking.yaml, ranking.yaml, index_policy.yaml",
        },
        {
          id: "e17", from: "ConfigCenter", to: "Validation", kind: "input",
          via: [[920, 80], [1030, 80], [1030, 560], [644, 560]],
          why: "Governance rules are externalized in config.",
          does: "Provides required fields and promotion rules.",
          executor: "Validation and promotion checks.",
          source: "config/governance/*",
        },
        {
          id: "e18", from: "AssetStore", to: "Retrieval", kind: "input",
          via: [[760, 320], [644, 340]],
          why: "Retrieval needs actual stored assets to search.",
          does: "Supplies assets/index entries for candidate recall.",
        },
        {
          id: "e19", from: "AssetStore", to: "Comparison", kind: "input",
          via: [[860, 320], [860, 480], [644, 480]],
          why: "Comparison needs reference artifacts.",
          does: "Provides historical baseline code/output.",
        },
      ];
